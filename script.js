...
const categories = {
  cakes: {
    ...
    items: [
      ...
      {id:3 , nameEn: 'mango Cake', nameAr: 'تورتة مانجا', descriptionEn: ['White Sponge Cake', 'Lebanese Cream', 'Imported Strawberry', 'Tropical Fruits', 'Imported Cherry', 'Strawberry Glaze'], descriptionAr: ['كيك إسفنج أبيض', 'كريمة لباني', 'فراولة مستوردة', 'فاكهة استوائية', 'شري مستورد', 'جليز فراولة'], price: 800, image: 'IMG_8980.JPG',available: true },
      ...
      {id:6.1 , nameEn: 'black Forest Cake larg', nameAr: 'تورتة وايت فوريست لارج', descriptionEn: ['Chocolate Cake', 'Caramel Mousse', 'Toffee Caramel', 'Walnuts', 'Cocoa Butter', 'Caramel Glaze'], descriptionAr: ['كيك شوكليت', 'موس كراميل', 'توفي كراميل', 'عين جمل', 'زبدة كاكاو', 'جليز كراميل'], price: 800, image: 'IMG_8976.JPG' ,available: true},
      {id:71. , nameEn: 'White Forest Cake larg', nameAr: 'تورتة بلاك فوريست لارج', descriptionEn: ['White Cake', 'Caramel Mousse', 'Toffee Caramel', 'Walnuts', 'Cocoa Butter', 'Caramel Glaze'], descriptionAr: ['كيك وايت', 'موس كراميل', 'توفي كراميل', 'عين جمل', 'زبدة كاكاو', 'جليز كراميل'], price: 800, image: 'IMG_8977.JPG',available: true }
  ...
  gato: {
    ...
    items: [
      {id:11 , nameEn: 'Lotus éclair', nameAr: 'إكلير اللوتس', descriptionEn: ['Choux pastry', 'Lebanese Cream', 'Lotus butter', 'Imported Lotus biscuit'], descriptionAr: ['اكلير', 'كريمه باستري', 'زبده لوتس', 'بسكويت لوتس مستورد'], price: 80, image: 'IMG_8822.JPG (1).jpeg' ,available: true},
      ...
      {id:15 , nameEn: 'Cigar Gateau', nameAr: 'جاتو السيجار', descriptionEn: ['Dark Mousse', 'Dark Mousse', 'Toffee Caramel', 'Coffee Ganache', 'Cocoa Butter'], descriptionAr: ['فادج شوكليت', 'موس درك', 'توفي كراميل', 'جناش قهوه', 'زبده الكاكاو'], price: 80, image: '17.JPG' ,available: true},
      {id:16 , nameEn: 'Classic Millie', nameAr: 'ميلفي كلاسيك', descriptionEn: ['Mille-feuille', 'Pastry cream', 'Fine sugar'], descriptionAr: ['ميلفيه', 'كريمه باستري', 'سكر ناعم'], price: 80, image: '18.JPG' ,available: true},
      ...
      {id:18 , nameEn: 'Mille-feuille Lotus', nameAr: 'ميلفي اللوتس', descriptionEn: ['Mille-feuille', 'Pastry cream', 'Lotus butter', 'Imported Lotus biscuit'], descriptionAr: ['ميلفيه', 'كريمه باستري', 'زبده لوتس', 'بسكويت لوتس'], price: 80, image: '20.JPG',available: true },
      {id:19 , nameEn: 'Rocher Gateau', nameAr: 'جاتو روشيه', descriptionEn: ['Magic Mousse', 'Fudge cake', 'Nutella', 'Crisp Crust'], descriptionAr: ['موس ماجيك', 'فادج كيك', 'نوتيلا', 'كورست كريب'], price: 80, image: '21.JPG' ,available: true},
      ...
      {id:45.2 , nameEn:'Pistachio éclair', nameAr: 'إكلير الفستق', descriptionEn: ['Pistachio Cake', 'Pistachio Mousse', 'Pistachio Crunch', 'Pistachio Glaze'], descriptionAr: ['كيك فسدق', 'موس فسدق', 'كروكند فسدق', 'جليز فسدق'], price:80, image:'14.3.JPG' ,available:true},
      ...
      {id:45.5 , nameEn:'Mango bean', nameAr: 'حبه مانجا', descriptionEn: ['White Mousse', 'Natural Mango Filling', 'Cocoa Butter', 'Pectin'], descriptionAr: ['موس وايت', 'حشو مانجو طبيعي', 'زبده الكاكاو', 'بكتين'], price:60, image:'IMG_8974.JPG' ,available:true}, 
      {id:45.6 , nameEn:'Coffee bean', nameAr: 'حبه قهوة', descriptionEn: ['Magic Mousse', 'Coffee Ganache', 'Fudge Cake', 'Coffee'], descriptionAr: ['موس ماجيك', 'جناش قهوه', 'فادج كيك', 'كوفي'], price:80, image:'IMG_8973.JPG' ,available:true},
      {id:45.7 , nameEn:'Lotus Gateau', nameAr: 'جاتوة لوتس', descriptionEn: ['Lotus Cake', 'Cheese Cream', 'Lotus Butter', 'Imported Lotus biscuit'], descriptionAr: ['كيك لوتس', 'كريمه تشيز', 'زبده لوتس', 'بسكويت لوتس مستورد'], price:80, image:'IMG_8972.JPG' ,available:true},
      {id:45.8 , nameEn:'Fruit Gateau', nameAr: 'جاتوة فاكهة', descriptionEn: ['Sablé biscuit', 'Pastry cream', 'Fresh Mango'], descriptionAr: ['بسكويت سابليا', 'كريمه باستري', 'مانجو فرش'], price:60, image:'IMG_8971.JPG' ,available:true},
      ...
      {id:45.13 , nameEn:'Magic Gateau', nameAr: 'جاتوة ماجيك', descriptionEn: [ 'Gianduja Mousse', 'Fudge Cake', 'Crisp Crust', 'Nutella'], descriptionAr: [ 'موس جندوجيا', 'فادج كيك', 'كورست كريب', 'نوتيلا'], price:80, image:'IMG_8966.JPG' ,available:true},
      {id:45.14 , nameEn:'Nutella Millie', nameAr: 'ميلفية نوتيلا', descriptionEn: ['Mille-feuille', 'Pastry cream', 'Nutella', 'Crisp Crust'], descriptionAr: ['ميلفيه', 'كريمه باستري', 'نوتيلا', 'كورست كريب'], price:80, image:'IMG_8965.JPG' ,available:true},
      ...
      {id:45.16 , nameEn:'festival', nameAr: 'فيستيفال', descriptionEn: ['Sablé biscuit', 'Pastry cream', 'Chocolate', 'Crisp Crust'], descriptionAr: ['بسكويت سابليا', 'كريمه باستري', 'شوكليت', 'كورست كريب'], price:80, image:'IMG_8913.JPG' ,available:true}
    ]
  },
  icecream: {
