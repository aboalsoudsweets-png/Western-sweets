...
const categories = {
  ...
  gato: {
    ...
    items: [
      {id:11 , nameEn: 'Lotus éclair', nameAr: 'إكلير اللوتس', price: 95, image: 'IMG_8822.JPG (1).jpeg' ,available: true},
      {id:13 , nameEn: 'Cheese lotus', nameAr: 'جبنة اللوتس', price: 120, image: '15.JPG',available: true },
      {id:14 , nameEn: 'Cheese Nutella', nameAr: 'جبنة نوتيلا', price: 90, image: '16.JPG' ,available: true},
      {id:15 , nameEn: 'Cigar Gateau', nameAr: 'جاتو السيجار', price: 85, image: '17.JPG' ,available: true},
      {id:16 , nameEn: 'Classic Millie', nameAr: 'ميلفي كلاسيك', price: 105, image: '18.JPG' ,available: true},
      {id:17 , nameEn: 'Cheese Sherry', nameAr: 'جبنة شيري', price: 80, image: '19.JPG' ,available: true},
      {id:18 , nameEn: 'Mille-feuille Lotus', nameAr: 'ميلفي اللوتس', price: 115, image: '20.JPG',available: true },
      {id:19 , nameEn: 'Rocher Gateau', nameAr: 'جاتو روشيه', price: 70, image: '21.JPG' ,available: true},
      {id:20 , nameEn:'Strawberry bean', nameAr: 'حبة فراولة  ', price:75, image:'22.JPG' ,available:true},
      {id:21 , nameEn:'Africano', nameAr: 'أفريكانو', price:75, image:'23.JPG' ,available:true},
      {id:42 , nameEn:'Gateau Coconut', nameAr: 'جاتو جوز الهند', price:75, image:'25.JPG' ,available:true},
      {id:45.1 , nameEn:'Raspberry bean', nameAr: 'حبة توت ', price:75, image:'14.2.JPG' ,available:true},
      {id:45.2 , nameEn:'Pistachio éclair', nameAr: 'إكلير الفستق', price:75, image:'14.3.JPG' ,available:true},
      {id:45.3 , nameEn:'Chocolate tacos', nameAr: 'تاكو الشوكولاتة', price:75, image:'14.4.JPG' ,available:true}
    ]
  },
  icecream: {
    ...
    items: [
      {id:51 , nameEn: 'Vanilla Ice Cream', nameAr: 'آيسكريم الفانيليا', price: 50, image: 'icecream-1.jpg',available: true },
      {id:52 , nameEn: 'Chocolate Ice Cream', nameAr: 'آيسكريم الشوكولاتة', price: 55, image: 'icecream-2.jpg',available: true },
      {id:53 , nameEn: 'Strawberry Ice Cream', nameAr: 'آيسكريم الفراولة', price: 55, image: 'icecream-3.jpg' ,available: true},
      {id:54 , nameEn: 'Pistachio Ice Cream', nameAr: 'آيسكريم الفستق', price: 60, image: 'icecream-4.jpg',available: true },
      {id:55 , nameEn: 'Mint Ice Cream', nameAr: 'آيسكريم النعناع', price: 50, image: 'icecream-5.jpg' ,available: true},
      {id:56 , nameEn: 'Mango Ice Cream', nameAr: 'آيسكريم المانجو', price: 55, image: 'icecream-6.jpg',available: true }
    ]
  },
  accessories: {
    ...
    items: [
      {id:61 , nameEn: 'Decorative Box', nameAr: 'صندوق ديكوري', price: 75, image: 'acc-1.jpg',available: true },
      {id:62 , nameEn: 'Ribbon Pack', nameAr: 'عبوة أشرطة', price: 40, image: 'acc-2.jpg',available: true },
      {id:63 , nameEn: 'Gift Bag', nameAr: 'حقيبة هدية', price: 30, image: 'acc-3.jpg' ,available: true},
      {id:64 , nameEn: 'Candle Set', nameAr: 'مجموعة شموع', price: 85, image: 'acc-4.jpg',available: true },
      {id:65 , nameEn: 'Chocolate Wrapper', nameAr: 'غلاف شوكولاتة', price: 25, image: 'acc-5.jpg' ,available: true},
      {id:66 , nameEn: 'Luxury Package', nameAr: 'عبوة فاخرة', price: 120, image: 'acc-6.jpg',available: true }
    ]
  }
};
